...
inline std::string get_token_endpoint() { return fmt::format("{}/{}", get_metadata_endpoint(), kTokenPath); }

inline std::string get_iam_endpoint() { return fmt::format("{}/{}", get_metadata_endpoint(), kCredsPath); }

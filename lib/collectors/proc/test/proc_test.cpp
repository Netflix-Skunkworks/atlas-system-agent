...
TEST(Proc, ParseSnmp) {
  ...
  EXPECT_EQ(messages.at(18), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=synSent:27.000000\n");
  EXPECT_EQ(messages.at(19), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=synRecv:0.000000\n");
  EXPECT_EQ(messages.at(20), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=finWait1:0.000000\n");
  EXPECT_EQ(messages.at(21), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=finWait2:0.000000\n");
  EXPECT_EQ(messages.at(22), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=timeWait:0.000000\n");
  EXPECT_EQ(messages.at(23), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=close:1.000000\n");
  EXPECT_EQ(messages.at(24), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=closeWait:0.000000\n");
  EXPECT_EQ(messages.at(25), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=lastAck:0.000000\n");
  EXPECT_EQ(messages.at(26), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=listen:0.000000\n");
  EXPECT_EQ(messages.at(27), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=closing:10.000000\n");
  EXPECT_EQ(messages.at(28), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=synSent:0.000000\n");
  EXPECT_EQ(messages.at(29), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=synRecv:0.000000\n");
  EXPECT_EQ(messages.at(30), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=finWait1:0.000000\n");
  EXPECT_EQ(messages.at(31), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=finWait2:0.000000\n");
  EXPECT_EQ(messages.at(32), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=timeWait:0.000000\n");
  EXPECT_EQ(messages.at(33), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=close:0.000000\n");
  EXPECT_EQ(messages.at(34), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=closeWait:0.000000\n");
  EXPECT_EQ(messages.at(35), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=lastAck:0.000000\n");
  EXPECT_EQ(messages.at(36), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=listen:0.000000\n");
  EXPECT_EQ(messages.at(37), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=closing:5.000000\n");
  EXPECT_EQ(messages.at(38), "C:net.ip.datagrams,nf.test=extra,proto=v6,id=in:26635.000000\n");
  EXPECT_EQ(messages.at(39), "C:net.ip.discards,nf.test=extra,proto=v6,id=in:0.000000\n");
  EXPECT_EQ(messages.at(40), "C:net.ip.datagrams,nf.test=extra,proto=v6,id=out:27662.000000\n");
  EXPECT_EQ(messages.at(41), "C:net.ip.discards,nf.test=extra,proto=v6,id=out:0.000000\n");
  EXPECT_EQ(messages.at(42), "C:net.ip.reasmReqds,nf.test=extra,proto=v6:0.000000\n");
  EXPECT_EQ(messages.at(43), "C:net.ip.ectPackets,nf.test=extra,proto=v6,id=capable:0.000000\n");
  EXPECT_EQ(messages.at(44), "C:net.ip.ectPackets,nf.test=extra,proto=v6,id=notCapable:26635.000000\n");
  EXPECT_EQ(messages.at(45), "C:net.ip.congestedPackets,nf.test=extra,proto=v6:0.000000\n");
  EXPECT_EQ(messages.at(46), "C:net.udp.datagrams,nf.test=extra,proto=v6,id=in:14.000000\n");
  EXPECT_EQ(messages.at(47), "C:net.udp.errors,nf.test=extra,proto=v6,id=inErrors:0.000000\n");
  EXPECT_EQ(messages.at(48), "C:net.udp.datagrams,nf.test=extra,proto=v6,id=out:14.000000\n");
  ...
  EXPECT_EQ(messages.at(36), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=listen:0.000000\n");
  EXPECT_EQ(messages.at(37), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=closing:5.000000\n");
  EXPECT_EQ(messages.at(38), "C:net.ip.datagrams,nf.test=extra,proto=v6,id=in:26735.000000\n");
  EXPECT_EQ(messages.at(39), "C:net.ip.discards,nf.test=extra,proto=v6,id=in:1.000000\n");
  EXPECT_EQ(messages.at(40), "C:net.ip.datagrams,nf.test=extra,proto=v6,id=out:28662.000000\n");
  EXPECT_EQ(messages.at(41), "C:net.ip.discards,nf.test=extra,proto=v6,id=out:2.000000\n");
  EXPECT_EQ(messages.at(42), "C:net.ip.reasmReqds,nf.test=extra,proto=v6:42.000000\n");
  EXPECT_EQ(messages.at(43), "C:net.ip.ectPackets,nf.test=extra,proto=v6,id=capable:42.000000\n");
  EXPECT_EQ(messages.at(44), "C:net.ip.ectPackets,nf.test=extra,proto=v6,id=notCapable:26645.000000\n");
  EXPECT_EQ(messages.at(45), "C:net.ip.congestedPackets,nf.test=extra,proto=v6:2.000000\n");
  EXPECT_EQ(messages.at(46), "C:net.udp.datagrams,nf.test=extra,proto=v6,id=in:24.000000\n");
  EXPECT_EQ(messages.at(47), "C:net.udp.errors,nf.test=extra,proto=v6,id=inErrors:1.000000\n");
  EXPECT_EQ(messages.at(48), "C:net.udp.datagrams,nf.test=extra,proto=v6,id=out:24.000000\n");
}

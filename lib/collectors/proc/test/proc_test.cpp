...
TEST(Proc, ParseSnmp) {
  ...
  EXPECT_EQ(messages.at(18), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=established:0.000000\n");
  EXPECT_EQ(messages.at(19), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=synSent:27.000000\n");
  ...
  EXPECT_EQ(messages.at(23), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=timeWait:0.000000\n");
  EXPECT_EQ(messages.at(24), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=close:1.000000\n");
  ...
  EXPECT_EQ(messages.at(27), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=listen:0.000000\n");
  EXPECT_EQ(messages.at(28), "g:net.tcp.connectionStates,nf.test=extra,proto=v4,id=closing:10.000000\n");
  ...
  EXPECT_EQ(messages.at(38), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=listen:0.000000\n");
  EXPECT_EQ(messages.at(39), "g:net.tcp.connectionStates,nf.test=extra,proto=v6,id=closing:5.000000\n");

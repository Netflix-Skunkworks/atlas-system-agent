...
5. **io.stat.too_many_fields** - More than 7 fields per line; extra fields are silently tolerated (e.g. io.cost extension keys). This test case is expected to **succeed**.
